# Matrix-Matrix multiply of two n x n matrices, iterative triple-loop method.
...
# seed, but not at the same n - the triple loop and BLAS differ by orders of
# magnitude and no single n makes both measurable.
