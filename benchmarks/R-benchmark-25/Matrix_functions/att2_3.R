# R-benchmark-25 (ATT) II.3: determinant of a 2500x2500 random matrix.
...
# determinant. setup() draws it once into `.data`. It is not cached on disk:
# 6.25M normals are drawn faster than the file is read back (see harness.R).
