...
A 2D random walk in three formulations: scalar, vectorised, and preallocated.

| | |
|---|---|
| Upstream | R Benchmark Suite (RB) <https://github.com/rbenchmark/benchmarks> |
| Original | Ross Ihaka, [Taupo handouts](https://www.stat.auckland.ac.nz/~ihaka/downloads/Taupo-handouts.pdf) |
